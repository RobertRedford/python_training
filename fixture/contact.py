...
class ContactHelper:
    ...
    def get_contact_info_from_edit_page(self, index):
        ...
        return Contact(firstname=firstname, lastname=lastname, address=address, id=id, homephone=home, workphone=work,
                       mobilephone=mobile, phone2=phone2, email=email, email2=email2, email3=email3)